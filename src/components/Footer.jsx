      ...
      <div className="container-custom py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              <HiBookOpen className="w-8 h-8 text-[#1A66CC]" />
              <span className="text-xl font-bold text-[#1A66CC]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Đọc Nhanh</span>
            </div>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Chuyên đào tạo kỹ thuật đọc nhanh, giúp học viên tăng tốc độ đọc từ 200 lên 1000+ từ/phút chỉ sau 6 buổi học.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#1A66CC] transition-colors duration-300">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold mb-4 text-[#1A66CC]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Liên kết nhanh</h3>
            <ul className="space-y-2">
              <li>
                <a href="#hero" className="text-gray-300 hover:text-[#1A66CC] transition-colors duration-300">
                  Trang chủ
                </a>
              </li>
              <li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold mb-4 text-[#1A66CC]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Dịch vụ</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-300 hover:text-[#1A66CC] transition-colors duration-300">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold mb-4 text-[#1A66CC]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Liên hệ</h3>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <HiLocationMarker className="w-5 h-5 text-[#1A66CC] flex-shrink-0" />
                <span className="text-gray-300">123 Đường ABC, Quận 1, TP.HCM</span>
              </div>
              <div className="flex items-center space-x-3">
                <HiPhone className="w-5 h-5 text-[#1A66CC] flex-shrink-0" />
                <span className="text-gray-300">0901 234 567</span>
              </div>
              <div className="flex items-center space-x-3">
                <HiMail className="w-5 h-5 text-[#1A66CC] flex-shrink-0" />
                <span className="text-gray-300">info@docnhanh.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <HiChat className="w-5 h-5 text-[#1A66CC] flex-shrink-0" />
        ...
        >
          <p className="text-gray-400">
            ...
            <a href="#" className="text-[#1A66CC] hover:text-[#1555B0] ml-2 transition-colors duration-300">
              Chính sách bảo mật
            </a> | 
            <a href="#" className="text-[#1A66CC] hover:text-[#1555B0] ml-2 transition-colors duration-300">
              Điều khoản sử dụng
