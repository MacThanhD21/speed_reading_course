    ...
    <section id="pricing" className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto">
          {/* Main Pricing Card */}
          <motion.div 
            className="relative bg-gradient-to-br from-[#1A66CC] to-[#1555B0] rounded-3xl p-8 md:p-12 text-white shadow-2xl"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
          >
            ...
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <div className="bg-[#34D399] text-white px-6 py-2 rounded-full font-semibold flex items-center space-x-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            <div className="text-center mb-8">
              <h3 className="text-3xl md:text-4xl font-bold mb-4" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Khoá học Kỹ Thuật Đọc Nhanh
              </h3>
              <p className="text-xl text-blue-100 mb-6" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center space-x-4 mb-2">
                ...
                <span className="text-xl text-blue-100">VNĐ</span>
              </div>
              <p className="text-blue-100 mb-4">
                <span className="line-through text-lg">1.500.000 VNĐ</span>
                <span className="ml-2 text-green-200 font-semibold">Tiết kiệm 300.000 VNĐ</span>
              </p>
              {/* Countdown Timer */}
              <div className="mb-4">
                <CountdownTimer 
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <HiCheck className="w-5 h-5 text-green-200 flex-shrink-0" />
            ...
            <div className="text-center">
              <motion.button
                onClick={scrollToCTA}
                className="bg-[#34D399] hover:bg-[#10B981] text-white font-bold py-4 px-8 rounded-xl text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
              ...
              <p className="text-blue-100 text-sm mt-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          ...
          >
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <HiClock className="w-8 h-8 text-[#1A66CC]" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <HiStar className="w-8 h-8 text-[#34D399]" />
              </div>
